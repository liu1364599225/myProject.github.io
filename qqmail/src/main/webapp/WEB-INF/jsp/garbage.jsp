...
<html>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/font-style.css" />
   	<link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/css/garbage/garbage.css"/>
  </head>
  <body>
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/main.js" ></script>
   	<script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/garbage/garbage.js" ></script>
   		...
   		<li>
   			...
   			<div id="head1" class="container-fluid">
				<div id="head1-1" class="col-md-3" >
					<span id="head1-1-span1" class="text-info"><b>垃圾箱</b></span><span id="">(共<span id="all_mail_num" ">${list_size }</span>封)<span id="show_nomail"> &nbsp;未读邮件&nbsp;</span><span id="noread_mail">${noread_list_size }&nbsp;封</span></span>
				</div>
			</div>
   		</li>
   		<li>
