...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/fuUpdate.css" />
...
<body>
	...
	<div class="container" style="background-color: white;">
		<div id="title" class="container-fluid">寄养用户信息</div>
		<div id="fosterUser" style="margin-top: 20px;">
			...
			<c:forEach  var="user" items="${userList}">
				<div id="fosterFamilyList">
					<div class="col-md-2 fosterFamilyList-text">${user.getFuAccountname() }</div>
					<div class="col-md-2 col-md-offset-1 fosterFamilyList-text">
						${user.getFuFosterusername() }
					</div>
					<div class="col-md-3 col-md-offset-1 fosterFamilyList-text"
						style="overflow: scroll; white-space: nowrap;">${user.getFuFeedbackinformation() }</div>
					<div class="col-md-2 col-md-offset-1 fosterFamilyList-text">
						<a href="${pageContext.servletContext.contextPath }/feedbackInformationPage.pet?accountName=${accountName}&fuId=${user.getFuId() }"> 回复反馈信息 </a>
					</div>
				</div>
			</c:forEach>
		</div>
