...
<body>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center"
			...
			<form style="margin-top: 20px;" action="${pageContext.servletContext.contextPath }/updatePet.pet?accountName=${accountName}&fuId=${fuId}" method="post">
			<input type="hidden" name="pId" value="${pet.getpId() }">
				<div class="information">
					<span class="information-title"> 宠物姓名： </span> <input type="text" name="pPetname"
