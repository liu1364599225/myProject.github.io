...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/ffUpdate.css" />
...
<body>
	...
	<div class="container" style="background-color: white;">
		<div id="title" class="container-fluid">寄养家庭信息</div>
		<div id="fosterUser" style="margin-top: 20px;">
			...
			<c:forEach  var="family" items="${ffList}">
				<div id="fosterFamilyList">
					...
					<div class="col-md-2 col-md-offset-1 fosterFamilyList-text">${family.getfAdoptername() }</div>
					<div class="col-md-3 col-md-offset-1 fosterFamilyList-text"
						style="overflow: scroll; white-space: nowrap;">${family.getfFeedbackinformation() }</div>
					<div class="col-md-2 col-md-offset-1 fosterFamilyList-text">
						<a href="${pageContext.servletContext.contextPath }/ffUpdatePage.pet?accountName=${accountName}&ffId=${family.getfId() }"> 修改 </a>
						<a href="${pageContext.servletContext.contextPath }/FffeedbackInformationPage.pet?accountName=${accountName}&fId=${family.getfId() }"> 回复反馈信息 </a>
					</div>
				</div>
			</c:forEach>
		</div>
