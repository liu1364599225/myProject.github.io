...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/fuUpdate.pet?accountName=${accountName}"> 返回上层页面 </a> <a
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
					<div>
						<span class="information-row-title"
							style="color: goldenrod; font-size: 20px;"> 用户反馈的信息 </span>
					</div>
				...
				<div class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
				<form action="${pageContext.servletContext.contextPath }/feedbackInformation.pet?accountName=${accountName}&fuId=${fuId}" method="post">
					<div>
						<span class="information-row-title"
