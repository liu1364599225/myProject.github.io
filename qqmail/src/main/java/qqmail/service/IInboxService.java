...
public interface IInboxService {
	public abstract List<MailPro> readAll_Inbox_Count(String inbox,int send_id);//联表查询（状态表和邮件表）
	...
	public abstract Status readBySendId(int senId,int time);//根据发送人id拿到状态id对应状态表中的内容
	
	public abstract void update(String afind,String unfind,int id);//更新邮箱查看状态
