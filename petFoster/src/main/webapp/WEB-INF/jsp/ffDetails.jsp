	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center">
			...
			<div class="information-row" style="text-align:center">
				<a class="btn btn-success" href="${pageContext.servletContext.contextPath }/passFamily.pet?fId=${family.getfId() }&accountName=${accountName}"> 通过 </a>
				<a class="btn btn-danger" href="${pageContext.servletContext.contextPath }/noPassFamily.pet?fId=${family.getfId() }&accountName=${accountName}"> 不通过 </a>
			</div>
		</div>
	</div>
