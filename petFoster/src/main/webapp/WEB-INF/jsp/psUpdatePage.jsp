...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/psUpdatePage.css" />
...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/psUpdate.pet?accountName=${accountName}"> 返回上层页面 </a>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center"
			...
			<div id="title" class="container-fluid">修改宠物店信息</div>

			<form style="margin-top: 20px;" action="${pageContext.servletContext.contextPath }/updatePs.pet?accountName=${accountName}" method="post" enctype="multipart/form-data">
				<input type="hidden" name="psId" value="${petShop.getPsId() }">
				<div class="information">
					<span class="information-title"> 账户名： </span> <input type="text" name="psAccountname"
						class="form-control information-input" value="${petShop.getPsAccountname() }">
				</div>

				<div class="prompt"></div>
				
				<div class="information">
					<span class="information-title"> 密码： </span> <input type="text" name="psPassword"
						class="form-control information-input" value="${petShop.getPsPassword() }">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 宠物店名： </span> <input type="text" name="psPetshopname"
						class="form-control information-input" value="${petShop.getPsPetshopname() }">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 联系方式： </span> <input type="text" name="psContactway"
						class="form-control information-input" value="${petShop.getPsContactway() }">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 联系地址： </span> <input type="text" name="psAddress"
						class="form-control information-input" value="${petShop.getPsAddress() }">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 可寄养的宠物类型： </span> <input name="psTyperange"
						type="text" class="form-control information-input" value="${petShop.getPsTyperange() }">
				</div>
				...
				<div class="information">
					...
					<div class="information-input">
						<input id="petShopPhoto" type="file" name="petShopPhoto"
