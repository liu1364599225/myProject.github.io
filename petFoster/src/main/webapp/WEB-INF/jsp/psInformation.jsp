...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/psInformation.css" />
...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			<div id="top-navigation-name">账户名:${petShop.getPsAccountname() }</div>
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/psAndffOrderPage.pet?oFosterplaceid=${petShop.getPsId() }&oFosterstyle=${oFosterstyle}"> 我的订单 </a>
			<a class="btn btn-danger btn-lg" href="${pageContext.servletContext.contextPath }/deletepsAccount.pet?psId=${petShop.getPsId() }"> 注销此账号 </a>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center">
			<div class="container-fluid information-title">宠物店信息</div>
			<div class="row">
				<div class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
					<div class="information-row">
						<span class="information-row-title">账户名：</span> <span>${petShop.getPsAccountname() }</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">宠物店名：</span> <span>${petShop.getPsPetshopname() }</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">可寄养的宠物类型：</span> <span>${petShop.getPsTyperange() }</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">联系方式：</span> <span>${petShop.getPsContactway() }</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">联系地址：</span> <span>${petShop.getPsAddress() }</span>
					</div>
					<div class="information-row">
			...
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
					<form action="${pageContext.servletContext.contextPath }/feedbackinformation2.pet?oFosterstyle=${oFosterstyle}" method="post">
						<div>
							<span class="information-row-title"
