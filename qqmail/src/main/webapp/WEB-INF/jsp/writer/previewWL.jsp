    	...
    	<div class="container-fluid center">
    		...
    		<div class="container-fluid" style="padding: 0px;margin-top: 15px;margin-bottom: 20px;">
	    		<div class="container-fluid content">
	    			...
	    			<span class="text" style="color: #5fa207;font-weight: bold;">${user.nickname }</span>
	    			<span class="text">< ${user.user_account } ></span>
	    		</div>
	    		<div class="container-fluid content">
	    		...
	    		<div class="container-fluid content">
	    			...
	    			<span class="text">${mailNumber}</span>
	    		</div>
	    	</div>
    	</div>
		<div class="container-fluid" style="padding: 30px;">
			<textarea class="richText" name="main_body" cols="100" rows="8">${mail.main_body }</textarea>
			<input type="hidden" id="notepaperImg" value="${notepaper.notepaper_img }">
		</div>
	</body>
</html>