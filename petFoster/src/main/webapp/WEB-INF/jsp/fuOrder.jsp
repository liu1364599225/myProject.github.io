...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/fuOrder.css" />
...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/fuIndex.pet?accountName=${accountName }"> 返回上层页面 </a> <a
			...
			<c:forEach  var="order" items="${myOrderList}">
				<div id="fosterFamilyList">
					...
					<div class="col-md-2 fosterFamilyList-text operation">
						<a class="hang" href="${pageContext.servletContext.contextPath }/hangOrder.pet?oId=${order.getoId() }&fuId=${fuId }">挂起</a>
						<a class="confirmation" href="${pageContext.servletContext.contextPath }/confirmationOrder.pet?oId=${order.getoId() }&fuId=${fuId}">确认订单</a>
						<a class="cancellation" href="${pageContext.servletContext.contextPath }/cancellationOrder.pet?oId=${order.getoId() }&fuId=${fuId}">取消订单</a>
						<a class="delete" href="${pageContext.servletContext.contextPath }/deleteOrder.pet?oId=${order.getoId() }&fuId=${fuId }">删除</a>
					</div>
				</div>
			</c:forEach>
		</div>
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath }/js/fuOrder.js" ></script>
</body>
</html>