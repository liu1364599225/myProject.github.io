...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/fuIndex.css" />
...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/fuInformation.pet?fuId=${fosterUser.getFuId()}"> 个人信息 </a>
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/fuOrderPage.pet?fuId=${fosterUser.getFuId()}"> 个人订单 </a>
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/hospital.pet?accountName=${fosterUser.getFuAccountname()}"> 医疗服务咨询 </a>
	...
	<div class="container" style="background-color: white;">
		<div id="search">
			<div class="col-md-3" style="height: 40px; line-height: 40px;">
				<span class="search-title"> 寄养方式： </span> <select id="typeSelect"
					class="btn btn-default">
					<option id="option1">寄养家庭寄养</option>
					<option id="option2">宠物店寄养</option>
				</select>
			</div>
...
<!-- 按地址搜索 -->			<!-- <div class="col-md-4" style="height: 40px; line-height: 40px;">
				<span class="search-title"> 详细地址： </span> <a
		...
		<div id="fosterFamily">
			<div id="fosterFamilyTitle">
				<div class="col-md-2 fosterFamilyList-title">寄养家庭图片</div>
				<div class="col-md-1 fosterFamilyList-title">收养人姓名</div>
				<div class="col-md-1 fosterFamilyList-title">收养人性别</div>
				<div class="col-md-2 fosterFamilyList-title">可寄养的宠物范围</div>
				<div class="col-md-2 fosterFamilyList-title">寄养经历</div>
				<div class="col-md-1 fosterFamilyList-title">联系方式</div>
				<div class="col-md-2 fosterFamilyList-title">联系地址</div>
				<div class="col-md-1 fosterFamilyList-title">开始寄养</div>
			</div>
			<c:forEach  var="family" items="${ffList}">
				<div id="fosterFamilyList">
					<div class="col-md-2 fosterFamilyList-text">
						<img src="${pageContext.servletContext.contextPath }${ family.getfFamilyphoto()}" width="80px" height="60px" />
					</div>
					...
					<div class="col-md-1 fosterFamilyList-text">
						<a href="${pageContext.servletContext.contextPath }/fuFfDetails.pet?fuId=${fosterUser.getFuId()}&fId=${family.getfId()}&style=寄养家庭"> 查看详细信息 </a>
					</div>
				</div>
			</c:forEach>
		</div>
		...
		<div id="petShop">
			<div id="fosterFamilyTitle">
				<div class="col-md-2 fosterFamilyList-title">宠物店图片</div>
				<div class="col-md-2 fosterFamilyList-title">宠物店名</div>
				<div class="col-md-2 fosterFamilyList-title">
					可寄养的宠物类型范围</div>
			...
			<c:forEach  var="petShop" items="${psList}">
				<div id="fosterFamilyList">
					<div class="col-md-2 fosterFamilyList-text">
						<img src="${pageContext.servletContext.contextPath }${petShop.getPsPetshopphoto()}" width="80px" height="60px" />
					</div>
					...
					<div class="col-md-1 fosterFamilyList-text">
						<a href="${pageContext.servletContext.contextPath }/fuPsDetails.pet?fuId=${fosterUser.getFuId()}&fId=${petShop.getPsId()}&style=宠物店"> 查看详细信息 </a>
					</div>
				</div>
			</c:forEach>
		</div>
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath }/js/fuIndex.js" ></script>
