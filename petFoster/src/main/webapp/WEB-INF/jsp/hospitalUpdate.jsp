...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/hospitalUpdate.css" />
...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/addHospitalPage.pet?accountName=${accountName}"> 新增合作医院 </a>
	...
	<div class="container" style="background-color: white;">
		<div id="title" class="container-fluid">合作医院信息</div>
		<div id="fosterUser" style="margin-top: 20px;">
			<div id="fosterFamilyTitle">
				<div class="col-md-2 fosterFamilyList-title">医院名</div>
				<div class="col-md-2 fosterFamilyList-title">服务介绍</div>
				<div class="col-md-2 fosterFamilyList-title">营业时间</div>
			...
			<c:forEach  var="hospital" items="${hospitalList}">
				<div id="fosterFamilyList">
					...
					<div class="col-md-2 fosterFamilyList-text"
						...
						${hospital.gethServiceintroduction()}</div>
					<div class="col-md-2 fosterFamilyList-text">${hospital.gethBusinesshours()}</div>
					...
					<div class="col-md-2 fosterFamilyList-text">
						<a href="${pageContext.servletContext.contextPath }/hospitalUpdatePage.pet?accountName=${accountName}&hId=${hospital.gethId()}"> 修改 </a>
						<a href="${pageContext.servletContext.contextPath }/deleteHospital.pet?accountName=${accountName}&hId=${hospital.gethId()}"> 删除 </a>
					</div>
				</div>
			</c:forEach>
		</div>
