...
<body>
	<div class="container-fluid">
		<div id="body1" class="container-fluid">
			<a href="javascript:void(0);"><div class="TAB"
					style="margin-left: 0px; background-color: #C1D9F3;">普通邮件</div></a> <a
				href="${pageContext.servletContext.contextPath }/groupMailPage.do"><div class="TAB">群邮件</div></a> <a
				href="javascript:void(0);"><div class="TAB">贺卡</div></a> <a
				href="${pageContext.servletContext.contextPath }/postcardPage.do"><div class="TAB">明信片</div></a>
		</div>
		<!--普通邮件-->
		<div id="ordinaryMail">
			<div id="body2" class="container-fluid" style="padding: 0px;">
				...
				</a> <a href="${pageContext.servletContext.contextPath }/rightPage.do">
							...
							<div class="mailList-list mail">
								<div class="container-fluid row-div1">
									<div class="container-fluid row-div-title">
										最近联系人 <a href="${pageContext.servletContext.contextPath}/deleteNowlinkman.do" style="float: right;"> 清空 </a>
									</div>
								...
								<div class="hidden-div" style="display: none;">
									<div class="hidden-fileUpload">
										<form action="${pageContext.servletContext.contextPath }/fileUp.do" method="post" enctype="multipart/form-data">
											...
											<input name="style" type="hidden" value="old">
										</form>
									</div>
