	...
	<body>
		...
		<div class="container" style="margin-top: 50px;position:relative;padding-left:300px;">
			<div class="singerImg-box">
				<img width="100%" height="100%" src="${special.specialPricture}" />
			</div>
			<div class="singer-details">
				<h1>${special.specialName}</h1>
				<div class="singer-details-text">${special.specialSketch}</div>
				<div class="moreDetails">
					...
					<div class="hidden-div" style="display: none;">
						<div class="moreDetails-div">
							<h3>专辑简介</h3>
							<textarea disabled="disabled" class="moreDetails-box">${special.specialSketch}</textarea>
						</div>
