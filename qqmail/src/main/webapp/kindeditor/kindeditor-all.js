...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	...
	arr.push('</head><body id="rich-text" ' + (bodyClass ? 'class="' + bodyClass + '"' : '') + '></body></html>');
	return arr.join('\n');
}
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		self.iframe = K('<iframe class="ke-edit-iframe" id="textareaframe" hidefocus="true" frameborder="0"' + iframeSrc + '></iframe>').css('width', '100%');
