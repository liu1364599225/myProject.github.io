...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/manager.pet?accountName=${accountName}"> 返回上层页面 </a>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center">
			<div class="container-fluid information-title">${petShop.getPsPetshopname() }详细信息</div>
			<div class="row">
				<div class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
					<div class="information-row" style="height:300px;">
						<img src="${pageContext.servletContext.contextPath }${petShop.getPsPetshopphoto() }" width="100%" height="300px" />
					</div>
			...
			<div class="information-row" style="text-align:center">
				<a class="btn btn-success" href="${pageContext.servletContext.contextPath }/passPetShop.pet?psId=${petShop.getPsId() }&accountName=${accountName}"> 通过 </a>
				<a class="btn btn-danger" href="${pageContext.servletContext.contextPath }/noPassPetShop.pet?psId=${petShop.getPsId() }&accountName=${accountName}"> 不通过 </a>
			</div>
		</div>
	</div>
