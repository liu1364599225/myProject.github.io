...
public interface IDraftService {
	public abstract List<MailPro> readAll_Draft_Count(String draft,int accept_id);//联表查询（状态表和邮件表）
	
	public abstract MailPro readAll_Draft_ById(String draft,int accept_id,int time);//查对应的单个邮件
	
	public abstract List<MailPro> readAll_Draft(String draft,int send_id,int begin,int end);//分页——联表查询（状态表和邮件表）
	
	public abstract List<MailPro> readAll_DraftPro(String draft,int send_id);//未读邮件数查询
