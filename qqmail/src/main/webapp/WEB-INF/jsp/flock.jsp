...
<html>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/font-style.css" />
   	<link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/css/flock/flock.css"/>
  </head>
  <body>
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/main.js" ></script>
   	<script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/flock/flock.js" ></script>
   
   <div id="send" class="container-fluid col-md-10">
   <div id="msg"></div>
   	<ul id="send_ul">
   		<li>
   			...
   			<div id="head1" class="container-fluid">
				<div id="head1-1" class="col-md-3" >
					<span id="head1-1-span1" class="text-info"><b>群邮件</b></span><span id="">(共<span id="all_mail_num" ">${list_size }</span>封)<span id="show_nomail"> &nbsp;未读邮件&nbsp;</span><span id="noread_mail">${noread_list_size }&nbsp;封</span></span>
				</div>
			</div>
   		</li>
   		<li>
   			<div id="head2" class="">
						...
						<a id="head2_a3" href="javascript:void(0)" onclick="report(this)" class="btn btn-default btn-lg active" role="button">举报</a>
						<a id="head2_a4" href="javascript:void(0)" onclick="all_read_fun(this)" class="btn btn-default btn-lg active" role="button">全部标记为已读</a>
				...
				<div id="head2_right1" class="col-md-4">
						<div id="head2_right1_child1" class="col-md-9 col-md-offset-5">
	...
	<div id="flock_mail" class="col-md-2" style="background-color: #C1D9F3;">
				<div id="flock_right_mail" class="col-md-12 col-lg-pull-1 ">
					<a href="" id="head2_a1_right" class="btn btn-default btn-lg active" role="button">写群邮件</a>
					<div id="flock_mail_1">
						<a href="${pageContext.servletContext.contextPath}/readAll_Flock.do?pageNum=0">所有群邮件</a>
					</div>
					
					<div id="flock_mail_cut">
					</div>
					<div id="all_a">
						<div id="div_mail_handle"  onclick="handle_window(this)">
							<a href="javascript:void(0)">java学习群</a>
						</div>
						<div id="mail_handle">
							<a href="">写群邮件</a>
							<br />
	...
	<script type="text/javascript">
		var i = 0;
		function handle_window(obj){
			
			if(i == 0){
				i = i +1;
				$(obj).css("background-color","#C1D9F3");
				$(obj).next().css("display","inline-block");
				$(obj).next().css("background-color","white");
				
			}else{
				i = 0;
				$(obj).css("background-color","#E0ECF9");
