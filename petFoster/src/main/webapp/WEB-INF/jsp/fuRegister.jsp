...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/fuRegister.css" />
...
<body>
	...
	<div id="center" class="container">
		<div id="fuRegister" class="col-md-5 col-md-offset-1">
			<div id="fuRegister-title">寄养用户注册申请</div>
			<form action="${pageContext.servletContext.contextPath }/fuRegister.pet" method="post" style="margin-top: 20px;">
				<div class="information">
					<span class="information-title"> 账户名： </span>
					<input id="accountName" name="fuAccountname" type="text" class="form-control information-input" placeholder="请设置要注册的账户名">
				</div>
				...
				<div class="information">
					...
					<input id="password" name="fuPassword" type="password" class="form-control information-input" placeholder="请设置登录密码">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 确认密码： </span>
					<input id="againPassword" name="againPassword" type="password" class="form-control information-input" placeholder="请确认登录密码">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 姓名： </span>
					<input id="UserName" name="fuFosterusername" type="text" class="form-control information-input" placeholder="请输入姓名">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 联系方式： </span>
					<input id="contactWay" name="fuContactway" type="text" class="form-control information-input"
						placeholder="请输入联系方式">
				</div>
				...
				<div class="information">
					<span class="information-title"> 联系地址： </span>
						<a href="javascript:void(0)" style="float: right;" class="pick-area pick-area7" id="address-a" name=""></a>
						<input type="hidden" id="address" name="fuAddress" class="pick-area-hidden" />
				</div>
				...
				<div class="information">
					...
					<div class="information-input">
						<li style="list-style-type: none;"><input type="radio"
							name="fuFosterusersex" value="男" checked="checked" />男 <input
							style="margin-left: 20px;" type="radio" name="fuFosterusersex"
							value="女" />女</li>
					</div>
				</div>
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath }/js/fuRegister.js" ></script>
