...
<body>
	<div id="top" class="container">
		...
		<div id="top-navigation">
			...
			<a class="btn btn-default btn-lg" href="${pageContext.servletContext.contextPath }/hospital.pet?accountName=${accountName}"> 返回上层页面 </a>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center">
			<div class="container-fluid information-title">${hospital.gethHospitalname()}详细信息</div>
			<div class="row">
				<div class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
					<div class="information-row" style="height:300px;">
						<img src="${pageContext.servletContext.contextPath }${hospital.gethHospitalphoto()}" width="100%" height="300px" />
					</div>
					<div class="information-row">
						<span class="information-row-title">医院名称：</span> <span>${hospital.gethHospitalname()}</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">营业时间：</span> <span>${hospital.gethBusinesshours()}</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">联系方式：</span> <span>${hospital.gethContactway()}</span>
					</div>
					<div class="information-row">
						<span class="information-row-title">联系地址：</span> <span>${hospital.gethAddress()}</span>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-10 col-md-offset-1" style="margin-bottom: 20px;">
					<div>
						<span class="information-row-title"
							style="color: goldenrod; font-size: 20px;"> 服务介绍 </span>
					</div>
					<textarea class="userInformation" name="fuInformation"
						readonly="readonly">${hospital.gethServiceintroduction()}</textarea>
				</div>
			</div>
		</div>
	</div>
