...
function page_t(obj){
	...
	window.location.href = basePath+"readAll_Send.do?pageNum="+a;
}
//-------------------单个已读---------------------------------------------------
function read(obj){
...
//-------------加入已发送----------------------------
function asend(obj){ 
	document.getElementById("msg").innerText = "不能加入到同级目录邮箱";
	document.getElementById("msg").style.display = "inline";
	//document.getElementById("msg").style.display = "inline";
	var t=setTimeout("document.getElementById('msg').style.display = 'none';",2000);
}
//-------------------------------跳转二级页面--------------------------------------------
function second(obj,time1,id){
	var ti = $(obj).parent().siblings()[3].children[0].innerText;
	window.location.href=basePath+"second5.do?time1="+ti+"&"+"sendId="+id;
}
//-------------------------------转发------------------------------------------------
