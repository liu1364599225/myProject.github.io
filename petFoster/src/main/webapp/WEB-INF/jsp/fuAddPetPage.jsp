...
<body>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3" id="center"
			...
			<form style="margin-top: 20px;" action="${pageContext.servletContext.contextPath }/fuAddPet.pet?accountName=${accountName}&fuId=${fuId}" method="post">
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath }/js/fuAddPetPage.js" ></script>
</body>
</html>