...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/css/psRegister.css" />
...
<body>
	...
	<div id="center" class="container">
		<div id="fuRegister" class="col-md-5 col-md-offset-1">
			<div id="fuRegister-title">宠物店注册申请</div>
			<form style="margin-top: 20px;" action="${pageContext.servletContext.contextPath }/psRegister.pet" method="post"
				enctype="multipart/form-data">
				<div class="information">
					<span class="information-title"> 账户名： </span> <input
						id="accountName" name="psAccountname" type="text"
						class="form-control information-input" placeholder="请设置要注册的账户名">
				</div>

				<div class="prompt"></div>

				<div class="information">
					<span class="information-title"> 密码： </span> <input id="password"
						name="psPassword" type="password" class="form-control information-input"
						placeholder="请设置登录密码">
				</div>
				...
				<div class="information">
					<span class="information-title"> 宠物店名： </span> <input id="petshopName"
						name="psPetshopname" type="text" class="form-control information-input"
						placeholder="请输入宠物店名">
				</div>
				...
				<div class="information">
					<span class="information-title"> 联系方式： </span> <input
						id="contactWay" name="psContactway"  type="text" class="form-control information-input"
						placeholder="请输入联系方式">
				</div>
				...
				<div class="information">
					<span class="information-title"> 联系地址： </span> <a
						href="javascript:void(0)" id="address-a" style="float: right;"
						class="pick-area pick-area7" name=""></a> <input type="hidden" id="address" name="psAddress"
						class="pick-area-hidden" />
				</div>
				...
				<div class="information">
					<span class="information-title"> 宠物店图片： </span>
					<div class="information-input">
						<input id="petShopPhoto" name="petShopPhoto" type="file"
				...
				<div class="information" style="height: 60px;">
					...
					<div class="information-input" style="margin-top: 20px;">
						<input type="checkbox" class="type" name="psTyperange" value="猫类" />猫类 
						<input type="checkbox" class="type" name="psTyperange" style="margin-left: 5px;" value="狗类" />狗类
						<input type="checkbox" class="type" name="psTyperange" style="margin-left: 5px;" value="鼠类" />鼠类
						<input type="checkbox" class="type" name="psTyperange" style="margin-left: 5px;" value="蛇类" />蛇类
						<input type="checkbox" class="type" name="psTyperange" style="margin-left: 5px;" value="鸟类" />鸟类
					</div>
				</div>
    ...
    <script type="text/javascript" src="${pageContext.servletContext.contextPath }/js/psRegister.js" ></script>
