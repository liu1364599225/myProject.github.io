...
function page_t(obj){
	...
	window.location.href = basePath+"readAll_Draft.do?pageNum="+a;
}
//-------------------单个已读---------------------------------------------------
function read(obj){
...
function second(obj,time1,id){
	...
	window.location.href=basePath+"second4.do?time1="+ti+"&"+"sendId="+id;
}
//-------------------------------转发------------------------------------------------
